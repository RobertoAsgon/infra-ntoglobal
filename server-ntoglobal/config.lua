...
-- CREATE USER 'root'@'localhost' IDENTIFIED BY 'server1010'; GRANT ALL PRIVILEGES ON *.* TO 'root'@'localhost'; FLUSH PRIVILEGES;
-- Deaths
...
ownerName = "Eros"
ownerEmail = "otserverhard@gmail.com"
