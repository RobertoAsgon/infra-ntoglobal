					...
					<div class="TableShadowContainerRightTop">
						...
						<div class="TableContentAndRightShadow" style="background-image: url('.$layout_name.'/images/content/table-shadow-rm.gif);">
							<div class="TableContentContainer">
								<table class="TableContent" style="border: 0px solid #363636;">
									<tbody>
										<tr style="background-color: #363636;">
										</tr>
											<tr class="Table" style="background-color: none;">
												<td style="width: 900; border: 0px; border-style: solid; border-color: #363636;">
															...
															<table border="0">
																<tr>
																	<td style="text-align: center; font-weight: bold;">
																		<font color="white">The Best Guilds</font>
																	</td>
																</tr>
															</table>
															</center>
            ...
            $main_content .= '
				...
				<div class="Home">
					...
					<div class="Text-Home">
						...
						<img src="layouts\tibiarl\images\right.png" alt="right">
					
						<iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fglobalnto%2F&tabs=timeline&width=500&height=500&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=609700053312964" width="500" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>

						<img src="layouts\tibiarl\images\left.png" alt="left">
