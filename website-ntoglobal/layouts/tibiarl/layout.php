...
<meta name="description" content="NTO Global é um MMORPG 2D criado pela comunidade fã de tibia e naruto.">
<meta name="author" content="Eddy">
<meta http-equiv="content-language" content="en">
<meta name="keywords" content="nto global, narutibia, otserver, nto">
<!--ICON-->
			...
			<div id="community_Submenu" class="Submenu">
				...
				<a href="?subtopic=killstatistics">
					<div id="submenu_killstatistics" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
						...
						<div id="ActiveSubmenuItemLabel_killstatistics" class="SubmenuitemLabel">Registro de Mortes</div>
						<div class="RightChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
					</div>
				</a>
...
<br><br>
                  		...
                  		<!-- premium theme box -->
						<div id="PremiumBox" class="Themebox vibrate-1" style="background-image:url(<?PHP echo $layout_name; ?>/images/themeboxes/premium/wikibox7.png);right: -53;top: 168;">
    						<div class="ThemeboxButton">
    							<form action="/wiki" method="post" style="padding:0px;margin:0px;">
									<div class="BigButton" style="background-image:url(<?PHP echo $layout_name; ?>/images/buttons/buttonpremium.png)">
										<div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);"><div class="BigButtonOver" style="background-image:url(<?PHP echo $layout_name; ?>/images/buttons/buttonpremium-hover.png);"></div>
											<input class="ButtonText" type="image" name="Get Premium" alt="Get Premium" src="<?PHP echo $layout_name; ?>/images/buttons/wikibutton.png">
										</div>
									</div>
								</form>  
							</div>
						...
						<div id="NetworksBox" class="Themebox" style="background-image:url(<?PHP echo $layout_name; ?>/images/themeboxes/networks/neetworksbox.png);">
  							<div id="FacebookBlock">
    							<div id="FacebookLikeBox">
      								<div class="fb-like-box fb_iframe_widget" data-href="https://www.facebook.com/globalnto" data-width="175" data-height="180" data-show-faces="true" data-stream="false" data-border-color="none" data-header="false" fb-xfbml-state="rendered">
										<span style="vertical-align: bottom; width: 181px; height: 180px;">
										</span>
									</div>
    							</div>
    							<div id="FacebookSendBox">
      								<div class="fb-send fb_iframe_widget" data-href="https://www.facebook.com/globalnto" data-width="50" data-height="20" fb-xfbml-state="rendered">
										<span style="vertical-align: bottom; width: 50px; height: 20px;">
										</span>
									</div>
    							</div>
    							<div id="FacebookLikes">
      								<div class="fb-like fb_edge_widget_with_comment fb_iframe_widget" data-href="https://www.facebook.com/globalnto" data-send="false" data-width="225" data-show-faces="false" fb-xfbml-state="rendered">
