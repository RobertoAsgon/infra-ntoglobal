...
$config['pagSeguro']['host'] = 'mysql'; // host banco de dados
$config['pagSeguro']['database'] = 'nto'; // nome do banco de dados
$config['pagSeguro']['databaseUser'] = 'root'; // usuario banco de dados
$config['pagSeguro']['databasePass'] = 'server1313'; // senha banco de dados﻿

# Account Maker Config
$config['site']['serverPath'] = "/home/server-ntoglobal/";
...
$config['site']['max_players_per_account'] = 50;
